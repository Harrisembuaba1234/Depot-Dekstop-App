...
public class Stok extends JTextField {
    private String placeholder = "Stok";
    ...
    public Stok(String text){
        initListener();
    }
 
    public Stok(int columns){
        initListener();
    }
 
    public Stok(String text, int columns){
        super(text, columns);
        initListener();
    }
 
    public Stok(Document doc, String text, int columns){
